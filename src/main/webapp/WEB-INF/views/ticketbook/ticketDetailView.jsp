                ...
                <div class="all" id="all__${ticketbook.no}">
                    ...
                    <table border="0" class="list">
                        ...
                        <tr>
                            ...
                            <td id="공연제목">
                                <div>
                                    ...
                                    <div id="일시">일시 : ${ticketbook.date } ${ticketbook.time }</div>
                                    <br>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td id="내용">
                                <div class="info">
                                    <div>장소 : ${ticketbook.theater }
                                        <div class="price"> 가격 : ${ticketbook.price} <br></div>
                                    </div>
                                    <div>좌석 : ${ticketbook.seat } <br></div>
                                    <div>캐스팅 : ${ticketbook.casting }<br></div>
                                    <div>후기 : ${ticketbook.review } <br></div>
                                    <div class="ticketBtn">
                                        <button type="button" onclick=" deleteticket(${ticketbook.no})" id="deletebtn"
                                                class="deletebtn">티켓삭제
                                        </button>
                                        <div>
                                            <button type="button"
                                                    onclick="location.href='/ticketbook/updateticketform/${ticketbook.no}'"
                                                    class="editbtn">티켓수정
                                            </button>
                                        </div>
