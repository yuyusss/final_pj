			...
			<div id="content">
				...
				<table class="insertmuscTable" style="margin: 0 auto;">
					<tr>
						<th>뮤지컬 번호</th>
						<td>
							<input type="text" name="" id="" maxlength="5" placeholder="지정할 뮤지컬번호를 입력하세요.">
					...
					<tr>
						<th>뮤지컬 해시태그</th>
						<td>
							<input type="text" name="" id="" maxlength="30" placeholder="#뮤지컬 #해시태그 형식으로 등록하세요.">
						</td>
					</tr>
					<tr>
						<th>공연장 이름</th>
						<td>
							<input type="text" name="" id="" maxlength="20" placeholder="등록한 뮤지컬의 공연장 이름을 입력하세요.">
						</td>
					</tr>
					<tr>
						<th>공연장 지도 링크</th>
						<td>
							<input type="text" name="" id="" maxlength="300" placeholder="공연장의 네이버 주소링크를 입력하세요.">
						</td>
					</tr>
					<tr>
						<th>공연 시작일</th>
						<td>
							<input type="text" name="" id="" maxlength="10" placeholder="YYYY-MM-DD">
						</td>
					</tr>
					<tr>
						<th>공연 종료일</th>
					...
					<tr>
						<th>뮤지컬 명대사</th>
						<td>
							<input type="text" name="" id="" maxlength="30" placeholder="등록할 뮤지컬의 명대사 또는 한마디">
						</td>
					</tr>
					<tr>
						<th>총 상영시간</th>
						<td>
							<input type="text" name="" id="" placeholder="숫자만 입력해주세요.ex:170분 - > 170">
						</td>
					</tr>
					<tr>
						<th>뮤지컬 시놉시스</th>
						<td>
							<input type="text" name="" id="" maxlength="300" placeholder="">
						</td>
					</tr>
					<tr>
						<th>뮤지컬 장르 번호</th>
					...
					<tr>
						<th>뮤지컬 포스터 파일 주소</th>
						<td>
							<input type="text" name="" id="" maxlength="50" placeholder="ex)/폴더명/파일이름.jpg">
					...
					<tr>
						<th>뮤지컬 공식 유튜브 주소</th>
						<td>
							<input type="text" name="" id="" maxlength="100" placeholder="ex)https://www.youtube.com">
						</td>
					</tr>
				</table>
