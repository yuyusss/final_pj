	...
	<body>
		...
		<div class="content_wrap">
			...
			<div class="content_list_title" style="text-align:left;">
				...
				<h2 style="margin-left: 50px">전체 뮤지컬</h2>
					<!-- <div class="voteMain">
					<input type="radio" id="tab1" name="show" checked/>
			        <input type="radio" id="tab2" name="show" />
			        <input type="radio" id="tab3" name="show" />
			        <input type="radio" id="tab4" name="show" />
			        <input type="radio" id="tab5" name="show" />
					<div class="tab">
			            <label for="tab1">전체</label>
			            <label for="tab2">오리지널/내한공연</label>
			            <label for="tab3">라이센스</label>
			            <label for="tab4">창작뮤지컬</label>
			            <label for="tab5">아동/가족</label>
			        </div></div> -->
