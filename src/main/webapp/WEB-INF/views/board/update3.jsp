...
<div class="writecontainer">
	<div class="row">
		<div class="board">
	      <h2>수정</h2>
	      <hr><hr><br>
	        <form id="boardform" name="boardform" class="boardform" action="<c:url value='/board/updateBoard3'/>" method = "POST" enctype="multipart/form-data" onSubmit="return Checkform()">
