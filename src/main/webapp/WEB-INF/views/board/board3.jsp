				...
				$.ajax({
					...
					success : function(result) {
						...
						result.forEach(function(item) {
							html += "<tr> <td>"+item.idx+"</td><td>"+item.memId+"</td><td><a style='text-decoration:none;' href = 'view3?idx=" + item.idx
									+ "'>" + item.title + "</a></td><td>"+item.contents+"</td><td>"+item.hits+"</td><td>"+item.writedate+"</td><td><a href='/board/deleteboard3/"+item.idx+"' style='text-decoration:none;'>&#10060;</a></td>"
						})
